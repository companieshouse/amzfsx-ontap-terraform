...
variable "chips_envp1rep_data_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1rep_lobdata_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1rep_arch_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1rep_redo_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1rep_data_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1rep_lobdata_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1rep_arch_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1rep_redo_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}
