...
resource "aws_cloudwatch_metric_alarm" "fsx_percent_used_capacity" {
  ...
  dimensions = {
    FileSystemId = aws_fsx_ontap_file_system.chips_envp1stf_fsx.id
  }
  statistic           = "Average"
  period              = 300
  ...
  alarm_actions       = [aws_sns_topic.chips_envp1stf_fsx[0].arn]
  ok_actions          = [aws_sns_topic.chips_envp1stf_fsx[0].arn]
        ...
        properties = {
          ...
          metrics = [
            [
              ...
              "PercentUsedCapacity",
              "FileSystemId",
              aws_fsx_ontap_file_system.chips_envp1stf_fsx.id
            ]
          ]
          stat   = "Average"
          period = 300
