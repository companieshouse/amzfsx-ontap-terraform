...
variable "chips_envp1stf_data_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1stf_lobdata_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1stf_arch_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1stf_redo_size" {
  type        = number
  description = "Volume Size in Mb"
  default     = 1
}

variable "chips_envp1stf_data_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1stf_lobdata_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1stf_arch_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}

variable "chips_envp1stf_redo_count" {
  type        = number
  description = "Volume Count"
  default     = 0
}
