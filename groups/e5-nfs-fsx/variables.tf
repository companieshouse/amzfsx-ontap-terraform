...
variable "fsx_auto_backup_retention" {
  type        = number
  description = "numberber of days to retain automatic backups. Setting this to 0 disables automatic backups. You can retain automatic backups for a maximum of 90 days."
  default     = "0"
}
