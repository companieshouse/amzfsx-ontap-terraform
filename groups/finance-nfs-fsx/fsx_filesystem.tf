resource "aws_fsx_ontap_file_system" "finance_nfs_fsx" {
  ...
  security_group_ids              = [aws_security_group.finance_nfs_fsx.id,aws_security_group.finance_nfs_fsx_nfs.id,aws_security_group.finance_nfs_fsx_cifs.id]
